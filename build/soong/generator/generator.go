...
func (g *Module) GenerateAndroidBuildActions(ctx android.ModuleContext) {
	...
	cstmCmd := customExpandVariables(ctx, String(g.properties.Cmd))
	...
	manifestName := "cstm.sbox.textproto"
	desc := "generate"
        name := "generator"
	...
	rawCommand, err := android.Expand(cstmCmd, func(name string) (string, error) {
		switch name {
		case "location":
